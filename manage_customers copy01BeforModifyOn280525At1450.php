                    ...
                    <?php if ($crud_permissions['flag_create'] === 'active' || $crud_permissions['flag_update'] === 'active'): ?>
                        <form method="POST" action="manage_customers.php">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="last_name" name="last_name" class="form-control" placeholder="Enter last name" value="<?php echo $last_name; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label for="email" class="col-sm-2 col-form-label"><strong>Email</strong></label>
                                <div class="col-sm-10">
                                    <input type="email" id="email" name="email" class="form-control" placeholder="Enter email" value="<?php echo $email; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label for="phone" class="col-sm-2 col-form-label"><strong>Phone</strong></label>
                                <div class="col-sm-10">
                                    <input type="text" id="phone" name="phone" class="form-control" placeholder="Enter phone" value="<?php echo $phone; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="created_at" name="created_at" class="form-control" placeholder="Enter created at" value="<?php echo $created_at; ?>" required>
                                </div>
                            </div>
