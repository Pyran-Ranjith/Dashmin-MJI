...
try {
    ...
    $query = "SELECT 
                ...
                sup.supplier_name,
                fq.supplier_id,
                rr.location_code AS rack_position,
                l.location_name,
                s.location_id,
                s.rack_id
                -- r.location_code 
        ...
        LEFT JOIN racks rr ON s.rack_id = rr.id
              WHERE 1=1";
    ...
    $parts = $conn->query("SELECT DISTINCT id, part_number FROM stocks ORDER BY part_number")->fetchAll(PDO::FETCH_ASSOC);
...
<div class="container mt-4">
    ...
    <div class="alert alert-info">
        <p>Please select a part number to see WAC</p>
        Weighted Average Cost (WAC) Explanation: 
        ...
        <div class="card-body">
            <form method="get" class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <a href="fifo_part_number_wac_Inquiry.php" class="btn btn-warning mt-4">Part Number WAC Inquiry</a>
                </div>
            </form>
        </div>
    </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($inventory as $item): ?>
                                <tr>
                                    ...
                                    <!-- <td><?= $item['rack_location'] ?? 'N/A' ?></td> -->
                                    <td><?= $item['rack_position'] ?? 'N/A' ?></td>
                                    <td>
