...
$filter_location = $_GET['filter_location'] ?? ''; // Add location filter
...
if (!empty($filter_location)) {
    $sql .= " AND s.location_id = :filter_location"; // Add location filter
}
...
try {
    ...
    if (!empty($filter_location)) {
        $stmt->bindValue(':filter_location', $filter_location); // Bind location filter
    }
    $stmt->execute();
