...
if (isset($_POST['save_stock'])) {
    ...
    try {
        if ($_POST['id']) {
            ...
            $sql = "INSERT INTO stocks (part_number, description, image, category_id, model_id, brand_id, cost, selling_price, stock_quantity, supplier_id, location_id)
                    VALUES (:part_number, :description, :image, :category_id, :model_id, :brand_id, :cost, :selling_price, :stock_quantity, :supplier_id, :location_id)";
            $stmt = $conn->prepare($sql);
            $stmt->execute([
                'part_number' => $part_number,
                'description' => $description,
            ...
            <div class="filter-section">
                ...
                <div class="filter-area">
                    <form method="GET" action="manage_stock.php">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="filter_part_number"><strong>Nmc Part Number</strong></label>
                            ...
                            <div class="col-md-3">
                                <label for="filter_part_number_omit"><strong>Part Number</strong></label>
