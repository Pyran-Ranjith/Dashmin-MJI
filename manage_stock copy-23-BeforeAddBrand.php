        ...
        <div class="card-body">
            ...
            <div class="filter-section">
                ...
                <form method="GET" action="manage_stock.php">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="filter_part_number">Nmc Part Number</label>
                        ...
                        <div class="col-md-3">
                            <label for="filter_part_number_omit">Part Number</label>
                            <select class="form-control" name="filter_part_number_omit" id="filter_part_number_omit">
                                <option value="">All</option>
                                <?php
                                $part_numbers_omit = $conn->query("SELECT DISTINCT part_number FROM stocks ORDER BY SUBSTR(part_number, 5)");
                        ...
                        <div class="col-md-3">
                            <label for="filter_model">Brand</label>
