...
if (isset($_POST['save_invoice'])) {
    ...
    foreach ($sales_ids as $sale_id) {
        ...
        $item_total_price = $sale['total_price'];

        $sql = "INSERT INTO invoice_items (invoice_id, sale_id, quantity, unit_price, total_price)
                VALUES ('$invoice_id', '$sale_id', '$quantity', '$unit_price', '$item_total_price')";
        $conn->query($sql);
...
$sales_result = $conn->query("SELECT sa.id, cu.first_name as first_name, cu.last_name, 
    ...
    sa.quantity_sold, sa.total_price, sa.sale_date
    FROM sales sa  
