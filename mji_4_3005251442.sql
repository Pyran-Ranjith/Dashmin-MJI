...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2025 at 12:06 PM
...
(9, 'Purchase ID: 1 | Part: 11 | Qty: 2 | Cost: 5000', '2025-05-29 08:01:54', 0, 0, 11, 1, NULL, 2, 5000.00, '2025-05-04 00:00:00');
...
(15867, 'img/*.*', 'active'),
(15868, 'lib/*.*', 'active'),
(15869, '404.php_', 'active'),
(15870, 'batch_compair_table_and_folder_list_difference.php', 'active'),
(15871, 'batch_compare_files_infolder_with_table.php', 'active'),
(15872, 'batch_copy_files_src_to_destination_folder_prod.php', 'active'),
(15873, 'batch_copy_files_src_to_destination_folder.php', 'active'),
(15874, 'dashboard.php', 'active'),
(15875, 'language.php', 'active'),
(15876, 'manage_customers.php', 'active'),
(15877, 'manage_invoices.php', 'active'),
(15878, 'manage_menuoptions.php', 'active'),
(15879, 'manage_role_menu_options-2.php', 'active'),
(15880, 'manage_roles.php', 'active'),
(15881, 'manage_sales.php', 'active'),
(15882, 'manage_stock.php', 'active'),
(15883, 'manage_supplier_purchases.php', 'active'),
(15884, 'generate_reports.php', 'active'),
(15885, 'manage_suppliers.php', 'active'),
(15886, 'manage_users.php', 'active'),
(15887, 'manage_categories.php', 'active'),
(15888, 'manage_menutags.php', 'active'),
(15889, 'manage_models.php', 'active'),
(15890, 'manage_inactive_records.php', 'active'),
(15891, 'manage_sales_test.php', 'active'),
(15892, 'batch_copy_files_src_to_destination_folder.php', 'active'),
(15893, 'maintain_src_file_list.php', 'active'),
(15894, 'manage_0104_MultyDropDownMenue.php Not Found', 'active'),
(15895, 'index.php', 'active'),
(15896, 'admin_dashboard.php', 'active'),
(15897, 'login.php', 'active'),
(15898, 'logout.php', 'active'),
(15899, 'header.php', 'active'),
(15900, 'style.css', 'active'),
(15901, 'view_invoice.php', 'active'),
(15902, 'footer.php', 'active'),
(15903, 'db.php', 'active'),
(15904, 'READ-ME.txt', 'active'),
(15905, 'chtgpt_dspare_dparts_dmanagement_new1.sql', 'active'),
(15906, 'images_cab-1536x480.jpg', 'active'),
(15907, 'images_shock-absorbers.jpg', 'active'),
(15908, 'images_nmc-award.jpg', 'active'),
(15909, 'images_other-brands.jpg', 'active'),
(15910, 'parameters.php', 'active'),
(15911, 'db.php', 'active'),
(15912, 'nmc-I.ico', 'active'),
(15913, 'nmc-II.ico', 'active'),
(15914, 'nmc.ico', 'active'),
(15915, 'README-This.md', 'active'),
(15916, 'nmc.jpg', 'active'),
(15917, 'about.php', 'active'),
(15918, 'contact.php', 'active'),
(15919, 'differentiation.php', 'active'),
(15920, 'products_&_services.php', 'active'),
(15921, 'About_us0.png', 'active'),
(15922, 'about-us1.jpg', 'active'),
(15923, 'contact_us.png', 'active'),
(15924, 'about-us2.jpg Not Found', 'active'),
(15925, 'about-us3.jpg', 'active'),
(15926, 'about-us4.jpg', 'active'),
(15927, 'Products_&_Services_NMC_files.png', 'active'),
(15928, 'kyb1.jpg', 'active'),
(15929, 'EXCEL-G.jpg', 'active'),
(15930, 'gas-a-just.jpg', 'active'),
(15931, 'ultra-pic1.jpg', 'active'),
(15932, 'AGV.jpg Not Found', 'active'),
(15933, 'flyer1.jpg', 'active'),
(15934, 'flyer2.jpg', 'active'),
(15935, 'flyer2.jpg', 'active'),
(15936, 'flyer3.jpg', 'active'),
(15937, 'flyer4.jpg', 'active'),
(15938, 'differentiation.png', 'active'),
(15939, 'about-us1.jpg', 'active'),
(15940, 'about-us2.jpg Not Found', 'active'),
(15941, 'about-us3.jpg', 'active'),
(15942, 'about-us4.jpg', 'active'),
(15943, 'AGX.jpg', 'active'),
(15944, 'footer1.php', 'active'),
(15945, 'index11.php', 'active'),
(15946, 'dashboard1.php', 'active'),
(15947, 'sfl_batch_transfer_all.php Not Found', 'active'),
(15948, 'header1_sidebar1.php', 'active'),
(15949, 'header1_navbar1.php', 'active'),
(15950, 'view_invoice.php', 'active'),
(15951, 'dashboard1.php', 'active'),
(15952, 'index11.php', 'active'),
(15953, 'index1.php', 'active'),
(15954, 'js/*.*', 'active'),
(15955, 'manage_orders.php', 'active'),
(15956, 'report_orders.php', 'active'),
(15957, 'report_sales.php', 'active'),
(15958, 'report_stocks.php', 'active'),
(15959, 'report_supplier_purchases.php', 'active'),
(15960, 'manage_types.php', 'active'),
(15961, 'manage_brands.php', 'active'),
(15962, 'fifo_inventory_report.php', 'active'),
(15963, 'export_fifo_report.php', 'active'),
(15964, 'manage_racks.php', 'active'),
(15965, 'send_email_slow_moving_items.php', 'active'),
(15966, 'fifo_part_number_wac_Inquiry.php', 'active'),
(15967, 'stock_valuation_report.php', 'active'),
(15968, 'export_stock_valuation_report.php', 'active');
...
(11, 2, '333125EE', 'Mitsubishi Lancer LEFT', '', 6, 100.00, NULL, 2, 2, 7, '2025-03-20 06:53:14', 'active', 2, 3, 0, '', NULL, NULL, 5, NULL),
...
--
ALTER TABLE `src_file_list_folder`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15969;
