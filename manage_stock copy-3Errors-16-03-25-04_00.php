...
if (isset($_GET['view'])) {
    ...
    , c.category_name as category_name, m.model_name, su.supplier_name 
    FROM stocks s 
...
";
if (!empty($st_pn_fi)) {
    $sql .= " AND s.part_number LIKE '%$st_pn_fi%'";
}
if (!empty($st_ds_fi)) {
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control" name="st_ca_fi">
                                    ...
                                    <?php while ($st_ca_fi = $st_ca_fi_re->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <option value="<?php echo $st_ca_fi['part_number']; ?>" <?php //if ($roles['id'] == $role_id) echo 'selected';?>>
                                            <?php echo $st_ca_fi['part_number']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
