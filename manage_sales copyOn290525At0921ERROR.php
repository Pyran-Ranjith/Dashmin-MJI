...
$stocks = $pdo->query("SELECT id, part_number, stock_quantity FROM stocks WHERE flag = 'active' ORDER BY part_number")->fetchAll(PDO::FETCH_ASSOC); // Only fetch active stocks
    ...
    <?php if ($crud_permissions['flag_create'] === 'active'): ?>
        ...
        <form method="POST" class="mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="selling_price" class="form-control" placeholder="Enter Selling Price" required value="<?= $edit['selling_price'] ?? '' ?>">
            </div>
            <div class="mb-3">
